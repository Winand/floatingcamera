...
"""
from qtpy import QtMultimedia as qtmm, QtMultimediaWidgets as qtmmw
...
class Cameras(QtCore.QObject):
    ...
    def start_camera(self, camera_id, view=None):
        ...
        self.current.error.connect(self.camera_error)
        self.current.start()

    def camera_error(self):
        self.error.emit(self.current.errorString())
